...
function OneInput(props) {
  return (
    <div className="info">
      ...
      <h2 onClick={() => {props.onSubmit({some: 'data'})}}>Click Me!</h2>
    </div>
  )
}
...
function TwoInput(props) {
  return (
    <form>
      ...
      <input type="submit" value={'Reveal Next Section'} onClick={() => {props.onSubmit({some: 'data'})}} />
    </form>
  )
}
...
export {OneInput, OneResponse, TwoInput, TwoResponse}
